...
export interface ApiChallengeChallenge extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    brag: Schema.Attribute.Text;
    category: Schema.Attribute.String;
    cgpa: Schema.Attribute.String;
    city: Schema.Attribute.String;
    color: Schema.Attribute.String;
    company: Schema.Attribute.String;
    companyBio: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    finaleDate: Schema.Attribute.String;
    grad_year: Schema.Attribute.String;
    judgingCriteria: Schema.Attribute.Text;
    ...
    personality_type: Schema.Attribute.String;
    phone: Schema.Attribute.String;
    points: Schema.Attribute.String;
    portfolio: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    question1: Schema.Attribute.Text;
    question2: Schema.Attribute.Text;
    registrationDeadline: Schema.Attribute.String;
    registrations: Schema.Attribute.Relation<
      'oneToMany',
      'api::registration.registration'
    >;
    roundStructure: Schema.Attribute.Text;
    shortlistDate: Schema.Attribute.String;
    skills: Schema.Attribute.String;
    stream: Schema.Attribute.String;
    submissionFormat: Schema.Attribute.Text;
...
export interface ApiRegistrationRegistration
  ...
  attributes: {
    answer1: Schema.Attribute.Text;
    answer2: Schema.Attribute.Text;
...
export interface ApiWallLoreWallLore extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Wall Lore';
    pluralName: 'wall-lores';
    singularName: 'wall-lore';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    red_flag: Schema.Attribute.Text;
    registrations: Schema.Attribute.Relation<
      'oneToMany',
      'api::registration.registration'
    >;
    resetPasswordToken: Schema.Attribute.String & Schema.Attribute.Private;
    resume: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    roast_us: Schema.Attribute.Text;
    role: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.role'
    >;
